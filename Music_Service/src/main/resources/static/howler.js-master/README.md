...
Additional information, live demos and a creator showcase are available at [howlerjs.com](https://howlerjs.com).
...
* Firefox 4.0+
* Safari 5.1.4+
* Mobile Safari 6.0+ (after creator input)
* Opera 12.0+
* Microsoft Edge
...
Each HTML5 Audio object must be unlocked individually, so we keep a global pool of unlocked nodes to share between all `Howl` instances. This pool gets created on the first creator interaction and is set to the size of this property.

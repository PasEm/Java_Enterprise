...
public class Main {
    ...
    public static void main(String[] args) {
        String source1 = "C:\\Users\\bloof\\Desktop\\Java_Enterprise\\Music_Service\\src\\test";
        String source2 = "../test";
...
//
//        User creator = applicationContext.getComponent(User.class);
//        System.out.println(creator == null ? null : creator.toString());
//
